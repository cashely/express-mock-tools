        ...
        case 0:
          (0, _prismaDB.transaction)(/*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(prisma) {
              var _req$body, name, open, webhook, user, result;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    _req$body = req.body, name = _req$body.name, open = _req$body.open, webhook = _req$body.webhook;
                    user = req.user;
                    _context5.next = 4;
            ...
            var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(prisma) {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  ...
                  case 4:
                    projectResult = _context7.sent;
                    if (!(projectResult.creatorId !== user.id)) {
                      _context7.next = 7;
                      break;
                    }
                    return _context7.abrupt("return", res.response.error(403, '该项目不是您创建的，无法更新'));
                  case 7:
                    _context7.next = 9;
            ...
            var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(prisma) {
              ...
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 4:
                    projectResult = _context9.sent;
                    if (!(projectResult.creatorId !== user.id)) {
                      _context9.next = 7;
                      break;
                    }
                    return _context9.abrupt("return", res.response.error(403, '该项目不是您创建的，无法删除'));
                  case 7:
                    _context9.next = 9;
                    return prisma.project.update({
                      where: {
