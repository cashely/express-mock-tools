...
router.get("/", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$query, _req$query$page, page, _req$query$pageSize, pageSize, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$query = req.query, _req$query$page = _req$query.page, page = _req$query$page === void 0 ? 1 : _req$query$page, _req$query$pageSize = _req$query.pageSize, pageSize = _req$query$pageSize === void 0 ? 10 : _req$query$pageSize;
          _context.next = 3;
          return _schedule["default"].list({
            page: page,
            pageSize: pageSize
          });
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          id = req.params.id;
          _context2.next = 3;
          return _schedule["default"].findOneById(id);
        case 3:
        ...
        case 0:
          _transaction["default"].start(/*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(t) {
              var _req$body, times, path, gap, method, result;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _req$body = req.body, times = _req$body.times, path = _req$body.path, gap = _req$body.gap, method = _req$body.method;
                    _context3.next = 3;
                    return _schedule["default"].models.Schedule.create({
                      times: times,
                      path: path,
                      gap: gap,
                      method: method,
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    id = req.params.id;
                    _context5.next = 3;
                    return _schedule["default"].deleteOneById(id, {
                      transaction: t
                    });
                  case 3:
