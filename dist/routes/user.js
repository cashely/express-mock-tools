        ...
        case 0:
          (0, _prismaDB.transaction)(/*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(prisma) {
              var _req$body, username, password, userResult;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 6:
                    return _context.abrupt("return", res.response.success((0, _utils.signToken)(userResult)));
                  case 7:
                  case "end":
        ...
        case 0:
          (0, _prismaDB.transaction)(/*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(prisma) {
              var _req$body2, username, password, email, inviteCode, user, inviteUser, userInstance;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    ...
                    return _context3.abrupt("return", res.response.error(400, '用户名或邮箱已存在'));
                  case 6:
                    inviteUser = {};
                    if (!inviteCode) {
                      _context3.next = 15;
                  ...
                  case 10:
                    inviteUser = _context3.sent;
                    if (inviteUser) {
                      _context3.next = 13;
                      break;
                    }
                    return _context3.abrupt("return", res.response.error(400, '改邀请码的用户不存在'));
                  case 13:
                    _context3.next = 15;
                  ...
                  case 15:
                    ...
                    if (!!inviteCode) {
                      userInstance.inviteUser.connect = {
                        id: inviteUser.id
                      };
                    }
                    _context3.next = 19;
            ...
            var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(prisma) {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    user = req.user;
                    userResult = prisma.user.findUnique({
                      where: {
                        id: user.id
                      }
                    });
                    documentResult = prisma.document.count({
                      where: {
                        creatorId: user.id
                      }
                    });
                  ...
                  case 5:
                    ...
                    res.response.success(_objectSpread(_objectSpread({}, users), {}, {
            ...
            var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(prisma) {
              ...
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 3:
                    _userResult = _context9.sent;
                    if (_userResult) {
                      _context9.next = 6;
                      break;
                    }
                    return _context9.abrupt("return", res.response.error(400, '邀请码错误'));
                  case 6:
                    _context9.next = 8;
                    return prisma.user.update({
                      id: _userResult.id
