...
var _schemaParser = _interopRequireDefault(require("../utils/schemaParser"));
...
router.use('/:projectAlias/*', /*#__PURE__*/function () {
        ...
        case 0:
          _transaction["default"].start(/*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(t) {
              var projectAlias, path, from, headers, method, result, findMatchDocument, documentJson, content, projectResult, _templateContent;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    // project的项目名称
                    projectAlias = req.params.projectAlias; // document的路径参数
                    path = req.params[0];
                    from = req.ip, headers = req.headers, method = req.method; // return res.json(req.headers)
                    _context.next = 5;
                  ...
                  case 5:
                    ...
                    findMatchDocument = result.filter(function (document) {
                      // 把/pet/{abc}/{abc}的结构，转换成/pet/*/*
                      // 然后用micromatch去匹配
                      // 匹配到了，就返回true
                      // 没有匹配到，就返回false
                      var regPath = document.path.replace(/{\w+}/ig, '*');
                      if (document.method === 'all' || document.method === 0) {
                        return true;
                      }
                      return (0, _micromatch.isMatch)("".concat(method.toUpperCase(), "_").concat(path), "".concat(document.method.toUpperCase(), "_").concat(regPath));
                    });
                    if (!(findMatchDocument.length === 0)) {
                      _context.next = 9;
                      break;
                    }
                    return _context.abrupt("return", res.status(404).send('document not found'));
                  case 9:
                    documentJson = findMatchDocument[0].toJSON();
                    _context.next = 12;
                  ...
                  case 12:
                    content = JSON.parse(documentJson.schema.content);
                    if (content) {
                      _context.next = 15;
                      break;
                    }
                    return _context.abrupt("return", res.send(content));
                  case 15:
                    if (documentJson.type === 0) {
                      content = (0, _schemaParser["default"])(content);
                    }
                  ...
                  case 19:
                    ...
                    _dForest["default"].forEachNode(content, function (node) {
