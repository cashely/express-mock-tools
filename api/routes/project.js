...
router.get('/', /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _project["default"].findAll({
            ...
            include: [{
              model: _project["default"].models.User,
              as: 'creator',
              attributes: ['id', 'username', 'avatar']
            }, {
              model: _project["default"].models.Document.unscoped('defaultScope'),
              as: 'documents'
            }]
          });
        case 3:
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, name, open, user, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, open = _req$body.open;
          user = req.user;
          _context3.prev = 2;
          _context3.next = 5;
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, user, projectResult, result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 5:
          projectResult = _context4.sent;
          if (!(projectResult.creatorId !== user.id)) {
            _context4.next = 8;
            break;
          }
          return _context4.abrupt("return", res.response.error(403, '该项目不是您创建的，无法更新'));
        case 8:
          _context4.next = 10;
          return _project["default"].updateOneById(id, req.body);
        case 10:
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 5:
          projectResult = _context5.sent;
          if (!(user.id !== projectResult.creatorId)) {
            _context5.next = 8;
            break;
          }
          return _context5.abrupt("return", res.response.error(403, '您没有权限删除该项目'));
        case 8:
          _context5.next = 10;
          return _project["default"].deleteOneById(id);
        case 10:
